...
class ProcInst extends Reader {
    ...
    get start() {
        return (this.cache.start ||
            (this.cache.start = (0, exports.readPosition)(this.data, 80)));
    }
    /**
     * Gets the start position of the processing instruction.
     *
    ...
    get end() {
        return (this.cache.end ||
            (this.cache.end = (0, exports.readPosition)(this.data, 8)));
    }
    /**
...
class Text extends Reader {
     ...
     */
    get start() {
        return this.cache.start || (this.cache.start = (0, exports.readPosition)(this.data, 20));
    }
    /**
     ...
     */
    get end() {
        return this.cache.end || (this.cache.end = (0, exports.readPosition)(this.data, 28));
    }
    /**
...
class Tag extends Reader {
    ...
    get openEnd() {
        return (this.cache.openEnd ||
            (this.cache.openEnd = (0, exports.readPosition)(this.data, 48)));
    }
    /**
    ...
    get closeStart() {
        return (this.cache.closeStart ||
            (this.cache.closeStart = (0, exports.readPosition)(this.data, 56)));
    }
    /**
    ...
    get closeEnd() {
        return (this.cache.closeEnd ||
            (this.cache.closeEnd = (0, exports.readPosition)(this.data, 64)));
    }
    /**
...
class SAXParser {
    ...
    eventToDetailConstructor = new Map([
        [exports.SaxEventType.Attribute, this.createDetailConstructor(Attribute)],
        [exports.SaxEventType.ProcessingInstruction, this.createDetailConstructor(ProcInst)],
        [exports.SaxEventType.OpenTag, this.createDetailConstructor(Tag)],
        [exports.SaxEventType.CloseTag, this.createDetailConstructor(Tag)],
        [exports.SaxEventType.OpenTagStart, this.createDetailConstructor(Tag)],
        [exports.SaxEventType.Text, this.createDetailConstructor(Text)],
        [exports.SaxEventType.Cdata, this.createDetailConstructor(Text)],
        [exports.SaxEventType.Comment, this.createDetailConstructor(Text)],
        [exports.SaxEventType.Doctype, this.createDetailConstructor(Text)],
        [exports.SaxEventType.Declaration, this.createDetailConstructor(Text)],
    ]);
    writeBuffer;
