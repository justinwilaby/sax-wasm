...
class Attribute extends Reader {
    ...
    name;
    value;
    constructor(buffer, ptr = 0, memory) {
...
class Text extends Reader {
     ...
     */
    get start() {
        return this.cache.start || (this.cache.start = (0, exports.readPosition)(this.data, this.ptr + 12));
    }
    /**
     ...
     */
    get end() {
        return this.cache.end || (this.cache.end = (0, exports.readPosition)(this.data, this.ptr + 20));
    }
    /**
    ...
    get value() {
        ...
        const vecPtr = (0, exports.readU32)(this.data, this.ptr + 4);
        const valueLen = (0, exports.readU32)(this.data, this.ptr + 8);
...
class Tag extends Reader {
    ...
    get openStart() {
        return (this.cache.openStart ||
            (this.cache.openStart = (0, exports.readPosition)(this.data, this.ptr + 40)));
    }
    /**
    ...
    get openEnd() {
        return (this.cache.openEnd ||
            (this.cache.openEnd = (0, exports.readPosition)(this.data, this.ptr + 48)));
    }
    /**
    ...
    get closeStart() {
        return (this.cache.closeStart ||
            (this.cache.closeStart = (0, exports.readPosition)(this.data, this.ptr + 56)));
    }
    /**
    ...
    get closeEnd() {
        return (this.cache.closeEnd ||
            (this.cache.closeEnd = (0, exports.readPosition)(this.data, this.ptr + 64)));
    }
    /**
    ...
    get attributes() {
        ...
        let ptr = (0, exports.readU32)(this.data, this.ptr + 16);
        const numAttrs = (0, exports.readU32)(this.data, this.ptr + 20);
        const attributes = [];
    ...
    get textNodes() {
        ...
        let ptr = (0, exports.readU32)(this.data, this.ptr + 28);
        const numTextNodes = (0, exports.readU32)(this.data, this.ptr + 32);
        const textNodes = [];
